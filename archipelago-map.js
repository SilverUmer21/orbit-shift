...
export async function createArchipelagoMap(mount,{pointerTarget=mount,completed=false}={}){
  ...
  function setCompleted(value){completed=value;ember.alpha=value?.88:.58;voidIsland.alpha=value?.68:.5;bridgeCore.tint=value?0xf2cf63:0xffffff;}
