...
function sizeCanvases(){const heights={320:568,390:844,430:932};for(const canvas of document.querySelectorAll("canvas")){canvas.style.width=`min(100%,${phone.value}px)`;canvas.style.height=`min(72vh,${heights[phone.value]}px)`;}}
